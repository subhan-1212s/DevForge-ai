...
import { Lock, Mail, Terminal, AlertTriangle, Eye, EyeOff, CheckCircle2, ArrowRight, X, Sparkles } from 'lucide-react';
      ...
      >
        ...
        <div className="bg-slate-900/80 backdrop-blur-2xl rounded-3xl p-8 border border-white/10 shadow-2xl relative overflow-hidden">
          <div className="flex items-center justify-between mb-6">
            ...
            <div className="flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-indigo-500/10 border border-indigo-500/20 text-[10px] text-indigo-400 font-medium">
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            >
              ...
              <p className="text-xs text-slate-400 mb-5 leading-relaxed">
                Enter your registered email address and we will dispatch a secure password reset link to your inbox via Brevo Mail.
              </p>
