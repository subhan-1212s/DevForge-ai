          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              <div className="flex justify-between items-center mb-1.5">
                <label className="block text-xs font-bold uppercase tracking-wider text-[#86868b] font-display">
                  Password
                </label>
                <a href="#" className="text-xs text-[#0071e3] hover:underline font-medium">
                  Forgot Password?
                </a>
              </div>
              <div className="relative">
